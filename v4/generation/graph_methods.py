...
from v4.graph import derive, prio, mylog, mylogend
...
from v4.belm import leximaxbm, sumbm, drastic
...
class GraphMethods:
    ...
    def run_all(self, interp):
        for g in self.rgs:
            ...
            if constants.FORMULA == constants.RUN_BM or constants.FORMULA == constants.RUN_BS:
                g.G.decision()
            elif constants.FORMULA == constants.RUN_JA:
                g.G.aggr()
            elif constants.FORMULA == constants.RUN_TD:
